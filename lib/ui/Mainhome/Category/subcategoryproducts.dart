...
class SubCategoryProducts extends StatefulWidget {
  SubCategoryProducts({Key? key, required this.Subid, required this.name, }) : super(key: key);
...
class _SubCategoryProductsState extends State<SubCategoryProducts> {
  void initState() {
    BlocProvider.of<ProductDetailsBloc>(context).add(FatchSubProduct(Subid:widget.Subid));
    super.initState();
  }
